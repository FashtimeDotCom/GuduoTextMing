package org.guduo.textming.webAction.Web;


import org.guduo.textming.webAction.Common.Request;
...
public class BaseWebAction {
    protected String serverHost = Constant.base_api;
    protected String serverUri = "/v2/IndexController.php";
    protected String secretId = Constant.SecretId;
    protected String secretKey = Constant.SecretKey;
