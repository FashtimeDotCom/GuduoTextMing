...
public class HanLP
{
    ...
    public static final class Config
    {
         ...
         * 情感分类词库
         */
        public static String SentimentDictionaryPath = "data/dictionary/sentiment/SentimentNatureDictionary.txt";
        ...
        static
        {
            ...
            try
            {
                ...
                if(System.getProperty("debug") != null){
                    root = p.getProperty("localroot", "").replaceAll("\\\\", "/");
                }else {
                    root =loader.getResource("/").getPath() + p.getProperty("root", "").replaceAll("\\\\", "/");
                }
                ...
                SentimentDictionaryPath = root + p.getProperty("SentimentDictionaryPath", SentimentDictionaryPath);
